...
export const UI = {
  vi: {
    ...
    'service.priceNote': 'Chi phí phụ thuộc tình trạng cụ thể. Bác sĩ báo giá đầy đủ sau khi khám, trước khi bắt đầu điều trị.',
    'services.title': 'Dịch vụ',
    'services.intro': 'Mỗi trang nói rõ quy trình, thời gian và những trường hợp không phù hợp. Chi phí báo sau khi khám.',
    'pricing.title': 'Bảng giá',
    'pricing.intro': 'Chi phí phụ thuộc tình trạng từng người, nên con số cuối cùng chỉ có sau khi khám. Điều chúng tôi cam kết là bạn biết đủ trước khi đồng ý.',
    ...
    'about.doctorsPending': 'Hồ sơ bác sĩ đang được hoàn thiện. Mỗi bác sĩ sẽ có bằng cấp, chứng chỉ kèm nơi cấp và năm cấp.',
    ...
    'blog.intro': 'Bài viết giải thích các vấn đề răng miệng thường gặp, viết cho người không có chuyên môn.',
    'blog.pending': 'Chưa có bài viết nào được đăng.',
    'notFound.title': 'Không tìm thấy trang',
    'notFound.body': 'Đường dẫn này không còn tồn tại. Có thể trang đã được chuyển sang địa chỉ mới.',
  ...
  en: {
    ...
    'service.priceNote': 'Cost depends on your specific case. The dentist gives a full quote after the examination, before treatment begins.',
    'services.title': 'Treatments',
    'services.intro': 'Each page sets out the procedure, the time it takes, and when it is not the right choice. Cost is quoted after an examination.',
    'pricing.title': 'Prices',
    'pricing.intro': 'Cost depends on each case, so the final figure only exists after an examination. What we commit to is that you know it all before you agree.',
    ...
    'about.doctorsPending': 'Dentist profiles are being completed. Each one will list qualifications and certificates with the issuing body and year.',
    ...
    'blog.intro': 'Articles explaining common dental problems, written for people without a clinical background.',
